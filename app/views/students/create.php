    ...
    <main class="w-full max-w-lg mx-auto bg-white rounded-2xl shadow-xl p-8 transform transition duration-500 hover:scale-105">
        ...
        <form action="/students/store" method="post" class="space-y-6">
            <div>
                ...
                <input type="text" id="last_name" name="last_name" class="w-full border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg px-4 py-2 transition-all duration-300" required>
            </div>
            <div>
                <label for="first_name" class="block font-semibold text-gray-700 mb-1">First Name</label>
                <input type="text" id="first_name" name="first_name" class="w-full border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg px-4 py-2 transition-all duration-300" required>
            </div>
            <div>
                <label for="email" class="block font-semibold text-gray-700 mb-1">Email</label>
                <input type="email" id="email" name="email" class="w-full border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg px-4 py-2 transition-all duration-300" required>
            </div>
