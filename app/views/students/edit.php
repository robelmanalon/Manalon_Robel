...
                <input type="text" name="last_name" value="<?= $student['last_name'] ?>" class="w-full border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg px-4 py-2 transition-all duration-300">
            </div>
            <div>
                <label class="block font-semibold text-gray-700 mb-1">First Name</label>
                <input type="text" name="first_name" value="<?= $student['first_name'] ?>" class="w-full border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg px-4 py-2 transition-all duration-300">
            </div>
            <div>
                <label class="block font-semibold text-gray-700 mb-1">Email</label>
                <input type="email" name="email" value="<?= $student['email'] ?>" class="w-full border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg px-4 py-2 transition-all duration-300">
            </div>
